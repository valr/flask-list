...
Revision ID: d5e850a80880
Revises: 
Create Date: 2021-07-07 22:31:05.826046
...
def upgrade():
    ...
    sa.Column('list_id', sa.Integer(), nullable=False),
    sa.Column('item_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('checked', 'counter', 'text', name='listitemtype'), nullable=False),
