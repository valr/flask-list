...
def create(category_id):
    ...
    return render_template(
        'item/create.html', title='Create Item', form=form,
...
def update(item_id):
    ...
    return render_template(
        'item/update.html', title='Update Item', form=form,
        cancel=url_for('item.list'))
...
def delete(item_id):
    ...
    return render_template(
        'item/delete.html', title='Delete Item', form=form,
        cancel=url_for('item.list'))
...
@login_required
def list():
    categories_items = database.session.query(Category, Item).outerjoin(
        Item).order_by(Category.name, Item.name).all()
