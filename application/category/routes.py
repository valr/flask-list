...
def create():
    ...
    return render_template(
        'category/create.html', title='Create Category', form=form,
...
def update(category_id):
    ...
    return render_template(
        'category/update.html', title='Update Category', form=form,
        cancel=url_for('category.list'))
...
def delete(category_id):
    ...
    return render_template(
        'category/delete.html', title='Delete Category', form=form,
        cancel=url_for('category.list'))
